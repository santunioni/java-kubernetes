...
<!-- Added by: santunioni, at: Tue 23 Mar 2021 08:44:55 PM -03 -->
...
4. **Forward the database port to localhost**    
...
8. **Push the already created image to Kubernetes**   
...
1. **Edit `hosts`**: map the correct IP: "<ip>	dev.local"
...
1. **Test (change your IP and PORT as you need)**    
    1. **Get users**    
...
1. Change CMD to ENTRYPOINT on Dockerfile    
...
1. Configure a remote debug in IntelliJ
